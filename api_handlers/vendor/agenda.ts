...
import { applyVendorScope, buildVendorAgenda } from '../../src/utils/vendorDashboard';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const { quotes, orders } = await readVendorCollections();
    ...
    const data = buildVendorAgenda(scopedQuotes, scopedOrders);
